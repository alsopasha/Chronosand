...
export const fragmentShader = `
    ...
    void main() {
        ...
        vec3 colour = albedo * (ambient + sun);

        vec3 darkTint = colour * vec3(0.02, 0.05, 0.12);
        colour = mix(colour, darkTint, textH * 0.98);
        ...
        colour += vec3(1.0, 0.95, 0.9) * waterSpec * textBlend * 1.5; 
        ...
        colour += caustics * vec3(0.85, 0.95, 1.0) * albedo * 1.5;

        float dist = length(uv - 0.5);
        colour *= smoothstep(1.2, 0.25, dist);
